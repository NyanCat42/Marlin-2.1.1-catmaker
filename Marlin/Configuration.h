...
#define STRING_CONFIG_H_AUTHOR "(Laurynas Agejevas)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "catmaker"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, 12, -2.2 }
...
#define SKEW_CORRECTION
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define YZ_DIAG_AC 281.8
    #define YZ_DIAG_BD 284.36
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN P2_06
  #define RGB_LED_G_PIN P2_06
  #define RGB_LED_B_PIN P2_06
  #define RGB_LED_W_PIN P2_06
#endif
